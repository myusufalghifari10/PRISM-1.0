...
# Handle transformers v4 vs v5 import paths
...
try:
    ...
    # may not exist in v5; define stubs if needed
    try:
        from transformers.modeling_utils import (
            SequenceSummary,
            find_pruneable_heads_and_indices,
        ...
        def find_pruneable_heads_and_indices(*args, **kwargs):
            raise NotImplementedError("Pruning not supported in this transformers version")
        def prune_conv1d_layer(*args, **kwargs):
            raise NotImplementedError("Pruning not supported in this transformers version")
from transformers.utils import logging
try:
    from transformers.utils.model_parallel_utils import assert_device_map, get_device_map
except ImportError:
    # Removed in transformers v5.x — define no-op stubs (not needed for PRISM)
