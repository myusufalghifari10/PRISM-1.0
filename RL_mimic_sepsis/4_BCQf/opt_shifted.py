...
def optimize_on_cluster(hyperparams):
    ...
    cluster.optimize_parallel_cluster_cpu(
        main,
        nb_trials=None,
        job_name="mimic_sepsis_dBCQf_shifted_job",
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_steps", type=int, default=10_000
    )  # Max number of training steps
    parser.add_argument(
        "--eval_frequency", type=int, default=100
    ...
    parser.opt_list(
        ...
        type=float,
        tunable=True,
        options=[0.0, 0.01, 0.05, 0.1, 0.3, 0.5, 0.75, 0.9999],
    )
